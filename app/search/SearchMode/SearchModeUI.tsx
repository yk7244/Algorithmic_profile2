            ...
            <div className="flex flex-col items-center gap-6 transition-all duration-500">
                ...
                <div className="flex flex-col items-center gap-4 ">
                    ...
                    >
                        ...
                        새롭게 탐색하고 싶은 알고리즘 정체성 키워드를 선택해주세요.
                        </div>
                        ...
                        {selectedImages.map((img) => (
                            <div 
                                key={img.id} 
                                className="bg-black/70 backdrop-blur-md px-4 py-2 rounded-full  animate-fadeIn"
                    ...
                    <button
                        ...
                        className={`text-black font-bold py-3 px-10 rounded-full 
                        transition-all duration-300 hover:scale-105 shadow-2xl text-xl hover:bg-blue-500 hover:text-white ${selectedImages.length !== 1 ? 'bg-gray-300 pointer-events-none' : 'bg-white '}`}

    ...
    <div className="bg-[#E1E8FC] rounded-2xl shadow p-6 w-full">
        ...
        <div className="flex flex-row justify-between items-center"> 
            <div className="flex flex-col pl-2  text-md">
                <div className="text-black mb-7 font-bold">새로운 알고리즘 시각화를 업데이트할 수 있어요</div>
            </div>
            ...
            <div className="flex flex-col pl-2">
                <div className="text-black mb-7 font-bold">다음 알고리즘 시각화 업데이트는 위 날짜에 예정되어 있어요</div>  
            </div>
        )}
    </div>
);

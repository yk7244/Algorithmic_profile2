...
import { Edit2, Save, RefreshCw, Search, Link } from "lucide-react";
...
export default function MyProfilePage() {
  ...
  const handleFrameStyleChange = (id: string, style: string) => {
    setFrameStyles(prev => ({
      ...prev,
      [id]: style
    }));
    ...
    <main className={`fixed inset-0 overflow-y-auto transition-colors duration-500 ${bgColor}`}>
      ...
      <div className="relative z-20 w-full">
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* DraggableImage 컴포넌트 렌더링-이미지클러스터 관련한거 다 여기서 연동 */}
